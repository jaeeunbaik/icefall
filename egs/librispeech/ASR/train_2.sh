...
ema_decay=0.999
ema_start_step=1000
exp_dir=conformer_ctc_sd_proj/train70000-epoch77-avg10/exp_kl_layer14

#
spec_aug_time_warp_factor=0              # default: 100
spec_aug_num_frame_masks=20                # default: 2  
spec_aug_feature_mask_size=27            # default: 27
spec_aug_num_features_masks=20              # default: 2
spec_aug_frames_mask_size=100             # default: 100
musan_ratio=0.95                           # default: 0.5
snr_range=0,5
