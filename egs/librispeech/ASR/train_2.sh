...
base_lr=5e-5                 # Base learning rate for plateau/constant scheduler
...
ema_decay=0.999
ema_start_step=1000
exp_dir=conformer_ctc_sd_proj/train70000-epoch77-avg10/exp_kl_layer4,9,13
